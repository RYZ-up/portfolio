...
export const socials = [
  { label: 'GitHub', color: '#6e40c9', href: 'https://github.com/RYZ-up' },
  { label: 'LinkedIn', color: '#0A66C2', href: 'https://www.linkedin.com/in/rayane-yazid/' },
  { label: 'CV', color: '#ff6ec7', href: CV_URL }
];
